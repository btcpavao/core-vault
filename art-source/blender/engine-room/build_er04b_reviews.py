"""Create deterministic ER-04b comparison boards without resizing sources."""
...
def main():
    combine(
        ...
        REVIEW_DIR / "er-04b-materials-hero.png",
        REVIEW_DIR / "er-04b-reference-comparison.png",
    )
    combine(
        REVIEW_DIR / "er-04-materials-hero.png",
        REVIEW_DIR / "er-04b-materials-hero.png",
        REVIEW_DIR / "er-04-vs-er-04b.png",
    )
