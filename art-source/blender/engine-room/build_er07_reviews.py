"""Create deterministic ER-07 comparison plates without resizing sources."""
...
def main():
    combine(
        ...
        REVIEW_DIR / "er-07-final-hero.png",
        REVIEW_DIR / "er-07-reference-comparison.png",
    )
    combine(
        REVIEW_DIR / "er-06b-detail-hero.png",
        REVIEW_DIR / "er-07-final-hero.png",
        REVIEW_DIR / "er-06b-vs-er-07.png",
    )
