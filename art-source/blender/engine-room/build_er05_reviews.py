"""Create deterministic ER-05 review comparisons without resizing sources."""
...
def main():
    combine(
        ...
        REVIEW_DIR / "er-05-reference-comparison.png",
    )
    combine(
        REVIEW_DIR / "er-04c-materials-hero.png",
        REVIEW_DIR / "er-05-lighting-hero.png",
        REVIEW_DIR / "er-04c-vs-er-05.png",
    )
